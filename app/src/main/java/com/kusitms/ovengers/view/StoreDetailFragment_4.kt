...
import com.kusitms.ovengers.databinding.FragmentStoreDetail4Binding
...
class StoreDetailFragment_4 : Fragment() {

    private lateinit var retAPIS: APIS
    lateinit var binding: FragmentStoreDetail4Binding
    var num : Int = 0
    ...
    override fun onCreateView(
        ...
        binding = FragmentStoreDetail4Binding.inflate(inflater, container, false)
